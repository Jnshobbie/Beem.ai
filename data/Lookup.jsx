...
export default {
  ...
  INPUT_PLACEHOLDER: 'Hi, im Beem your ai engineer!',
  SIGNIN_HEADING: 'Continue With BEEM 2.0',
  SIGNIN_SUBHEADING: 'To use BEEM you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using BEEM, you agree to the collection of usage data for analytics.',
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use BEEM a few times per week.',
      price:9.99
    },
    {
      name:'Pro',
